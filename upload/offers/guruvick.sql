...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2016 at 03:31 PM
...
-- Database: `guruvick`
--
CREATE DATABASE IF NOT EXISTS `guruvick` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `guruvick`;
...
INSERT INTO `ads` (`ad_id`, `ad_title`, `ad_desc`, `man_fact`, `state`, `city`, `default_img`, `mobile1`, `mobile2`, `price`, `ad_type`, `ad_status`, `AddUser`, `DateTime`) VALUES
(1, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(2, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(3, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(4, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(5, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(6, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(7, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33'),
(8, 'Computer Equipment State', '', 'MFG Year 2006', 1, 1, 'http://nexgen/guruvick.comadmin/site/assets/imgs/common/default_product_img.png', '8506964846', '', '20000', 1, 1, 1, '2016-11-08 05:20:33');

-- --------------------------------------------------------

--
-- Table structure for table `ads_enquiry`
--

CREATE TABLE IF NOT EXISTS `ads_enquiry` (
  `ad_enq_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ad_id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `enquiry` text NOT NULL,
  `ad_en_status` int(11) NOT NULL DEFAULT '0',
  `ad_enqDateTine` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ad_enq_id`)
...
CREATE TABLE IF NOT EXISTS `ad_media` (
  `ad_media` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `mediaType` int(11) NOT NULL DEFAULT '0' COMMENT '0 image ,1 video',
  `fileName` text NOT NULL,
  `DateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ad_media`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `ad_to_category`
--

CREATE TABLE IF NOT EXISTS `ad_to_category` (
  `atoc_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ad_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  `b_sort` int(11) NOT NULL DEFAULT '1000',
  `bannerLocation` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `banner` (`b_id`, `b_title`, `b_img`, `b_link`, `b_sort`, `bannerLocation`, `b_status`, `DateTime`) VALUES
(1, 'Latest Offer', 'http://nexgen/guruvick.comadmin/site//assets/imgs/banner_ads/banner_ad.png', 'http://google.co', 1000, 0, 1, '2016-11-08 05:40:49'),
(2, 'Latest Offer', 'http://nexgen/guruvick.comadmin/site//assets/imgs/banner_ads/banner_ad.png', 'http://yahoo.co', 1000, 1, 1, '2016-11-08 05:40:49'),
(3, 'Latest Offer', 'http://nexgen/guruvick.comadmin/site//assets/imgs/banner_ads/banner_ad.png', 'http://yahoo.co', 1000, 1, 1, '2016-11-08 05:40:49');

-- --------------------------------------------------------

--
-- Table structure for table `banner_to_category`
--

CREATE TABLE IF NOT EXISTS `banner_to_category` (
  `btoc_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '0 top ,1 footer',
...
INSERT INTO `category` (`category_id`, `category_name`, `icon`, `parent_id`, `layout`, `sort`, `AddUser`, `ModeUser`, `AddDateTime`, `ModeDateTime`, `status`, `description`, `type`) VALUES
(1, 'Printer', '', 59, 'category', 2, 1, NULL, '2016-06-22 00:00:00', '2016-06-22 01:53:01', 1, '', 0),
(43, 'Home Decore', '', 59, 'category', 3, 0, NULL, '0000-00-00 00:00:00', '2016-09-06 14:15:33', 1, '', 0),
(44, 'Software', '', 59, 'category', 1, 0, NULL, '0000-00-00 00:00:00', '2016-09-06 14:15:52', 1, '', 0),
(46, 'Cars', '', 59, 'category', 4, 0, NULL, '0000-00-00 00:00:00', '2016-09-06 14:17:04', 1, '', 0),
(47, 'Servent', '', 59, 'category', 6, 0, NULL, '0000-00-00 00:00:00', '2016-09-09 12:15:44', 1, '', 0),
(54, 'Pets', '', 59, 'category', 5, 0, NULL, '0000-00-00 00:00:00', '2016-10-08 10:07:34', 1, '', 0),
(55, 'Computer', '', 59, 'category', 0, 0, NULL, '0000-00-00 00:00:00', '2016-10-19 07:40:27', 1, '', 0),
(56, 'Trucks', '', 59, 'category', 99, 0, NULL, '0000-00-00 00:00:00', '2016-10-31 09:15:22', 1, 'Desc', 1),
(57, 'Home', 'glyphicon glyphicon-home', 0, 'home', 0, 0, NULL, '0000-00-00 00:00:00', '2016-10-31 09:15:22', 1, 'Desc', 1),
(58, 'What we do?', 'glyphicon glyphicon-book', 0, 'what_we_do', 1, 0, NULL, '0000-00-00 00:00:00', '2016-10-31 09:15:22', 1, 'Desc', 1),
(59, 'Categories', 'glyphicon glyphicon-duplicate', 0, 'category', 2, 0, NULL, '0000-00-00 00:00:00', '2016-10-31 09:15:22', 1, 'Desc', 1),
(60, 'Contact Us', 'glyphicon glyphicon-earphone', 0, 'contact_us', 3, 0, NULL, '0000-00-00 00:00:00', '2016-10-31 09:15:22', 1, 'Desc', 1);
...
--
-- Table structure for table `custom_req`
--

CREATE TABLE IF NOT EXISTS `custom_req` (
  `cr_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cr_title` varchar(60) NOT NULL,
...
--
-- Dumping data for table `custom_req`
--

INSERT INTO `custom_req` (`cr_id`, `cr_title`, `location`, `c_name`, `mobile`, `description`, `status`, `DateTime`) VALUES
(1, 'kuldeep', 0, 'singh', '98685335687', 'wlecoome', 0, '2016-11-01 07:14:07');
...
INSERT INTO `layout` (`layout_id`, `layout_name`, `status`) VALUES
(1, 'home', 1),
(2, 'make_a_free_ad', 1),
(3, 'category', 1),
(4, 'contact_us', 1),
...
CREATE TABLE IF NOT EXISTS `modules` (
  ...
  `module_layout` varchar(100) NOT NULL,
...
INSERT INTO `modules` (`store_id`, `module_id`, `module_layout`, `page`, `module_class`, `module_setting`, `sort`, `status`) VALUES
(1, 2, 'Top', 'home', 'slider/c_slider', '', 1, 1),
(1, 3, 'Left', 'home', 'banner/c_banner', '0', 0, 1),
(1, 4, 'Right', 'home', 'banner/c_banner', '1', 0, 1),
(1, 5, 'Center', 'home', 'banner/c_banner', '2', 1000, 0),
(1, 7, 'Center', 'home', 'ads/c_ads', '', 2, 1),
(1, 8, 'Center', 'home', 'category/c_category', '', 1, 1),
(1, 9, 'Center', 'home', 'search/c_search', '', 0, 1),
(1, 11, 'Top', 'terms_condition', 'slider/c_slider', '', 1, 1),
(1, 12, 'Left', 'terms_condition', 'banner/c_banner', '0', 0, 1),
(1, 13, 'Bottom', 'home', 'custom_req/c_custom_req', '', 0, 1),
(1, 14, 'Right', 'terms_condition', 'banner/c_banner', '1', 0, 1),
(1, 15, 'Center', 'terms_condition', 'banner/c_banner', '2', 1000, 0),
(1, 18, 'Top', 'category', 'slider/c_slider', '', 1, 1),
(1, 19, 'Left', 'category', 'banner/c_banner', '0', 0, 1),
(1, 20, 'Right', 'category', 'banner/c_banner', '1', 0, 1),
(1, 21, 'Center', 'category', 'banner/c_banner', '2', 1000, 0),
(1, 22, 'Bottom', 'All', 'footer', '', 1000, 1),
(1, 24, 'Top', 'contact_us', 'slider/c_slider', '', 1, 1),
(1, 25, 'Left', 'contact_us', 'banner/c_banner', '0', 0, 1),
(1, 26, 'Right', 'contact_us', 'banner/c_banner', '1', 0, 1),
(1, 27, 'Center', 'contact_us', 'banner/c_banner', '2', 1000, 0),
(1, 30, 'Top', 'express_ads', 'slider/c_slider', '', 1, 1),
(1, 31, 'Left', 'express_ads', 'banner/c_banner', '0', 0, 1),
(1, 34, 'Right', 'express_ads', 'banner/c_banner', '1', 0, 1),
(1, 35, 'Center', 'express_ads', 'banner/c_banner', '2', 1000, 0),
(1, 38, 'Top', 'faq', 'slider/c_slider', '', 1, 1),
(1, 39, 'Left', 'faq', 'banner/c_banner', '0', 0, 1),
(1, 40, 'Right', 'faq', 'banner/c_banner', '1', 0, 1),
(1, 41, 'Center', 'faq', 'banner/c_banner', '2', 1000, 0),
(1, 44, 'Top', 'privacy_policy', 'slider/c_slider', '', 1, 1),
(1, 45, 'Left', 'privacy_policy', 'banner/c_banner', '0', 0, 1),
(1, 46, 'Right', 'privacy_policy', 'banner/c_banner', '1', 0, 1),
(1, 47, 'Center', 'privacy_policy', 'banner/c_banner', '2', 1000, 0),
(1, 50, 'Top', 'product', 'slider/c_slider', '', 1, 1),
(1, 51, 'Left', 'product', 'banner/c_banner', '0', 0, 1),
(1, 52, 'Right', 'product', 'banner/c_banner', '1', 0, 1),
(1, 53, 'Center', 'product', 'banner/c_banner', '2', 1000, 0),
(1, 56, 'Top', 'what_we_do', 'slider/c_slider', '', 1, 1),
(1, 57, 'Right', 'what_we_do', 'banner/c_banner', '1', 0, 1),
(1, 59, 'Center', 'what_we_do', 'banner/c_banner', '2', 1000, 0),
(1, 61, 'Left', 'what_we_do', 'banner/c_banner', '0', 0, 1),
(1, 62, 'Center', 'terms_condition', 'search/c_search', '', 0, 1),
(1, 63, 'Bottom', 'terms_condition', 'custom_req/c_custom_req', '', 0, 1),
(1, 65, 'Center', 'category', 'category/c_category', '', 1, 1),
(1, 66, 'Center', 'category', 'search/c_search', '', 0, 1),
(1, 67, 'Bottom', 'category', 'custom_req/c_custom_req', '', 0, 1),
(1, 68, 'Center', 'contact_us', 'search/c_search', '', 0, 1),
(1, 69, 'Bottom', 'contact_us', 'custom_req/c_custom_req', '', 0, 1),
(1, 70, 'Center', 'privacy_policy', 'search/c_search', '', 0, 1),
(1, 71, 'Bottom', 'privacy_policy', 'custom_req/c_custom_req', '', 0, 1),
(1, 72, 'Center', 'express_ads', 'search/c_search', '', 0, 1),
(1, 73, 'Bottom', 'express_ads', 'custom_req/c_custom_req', '', 0, 1),
(1, 74, 'Center', 'faq', 'search/c_search', '', 0, 1),
(1, 75, 'Bottom', 'faq', 'custom_req/c_custom_req', '', 0, 1),
(1, 76, 'Center', 'product', 'search/c_search', '', 0, 1),
(1, 77, 'Bottom', 'product', 'custom_req/c_custom_req', '', 0, 1),
(1, 78, 'Center', 'what_we_do', 'search/c_search', '', 0, 1),
(1, 79, 'Bottom', 'what_we_do', 'custom_req/c_custom_req', '', 0, 1),
(1, 80, 'Bottom', 'home', 'express_ads/c_express_ads', '', 1, 1),
(1, 83, 'Center', 'login', 'account/c_login', '', 1, 1),
(1, 84, 'Center', 'login', 'search/c_search', '', 0, 1),
(1, 85, 'Right', 'login', 'banner/c_banner', '1', 0, 1),
(1, 86, 'Left', 'login', 'banner/c_banner', '1', 0, 1),
(1, 87, 'Top', 'All', 'header', '', 0, 1),
(1, 88, 'Center', 'registraction', 'account/c_registration', '', 1, 1),
(1, 89, 'Center', 'registraction', 'search/c_search', '1', 0, 1),
(1, 91, 'Center', 'makeafreead', 'ads/free_ad', '1', 1, 1);
...
INSERT INTO `pages` (`page_id`, `store_id`, `menuTitle`, `pageContent`, `module_name`, `sort`, `status`, `addDate`) VALUES
(5, 45, 'About us', '<div>\n<div class="gmail_default" style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">\n<h1 class="gmail_default"><strong><span style="font-family: verdana, sans-serif;">About Bigbasta</span></strong></h1>\n<div class="gmail_default">&nbsp;</div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">Our main goal is to give the least expensive approach to shop online in India. Whether you are purchasing mobiles, books, clothing, footwear, portable workstations, cameras, toys, infant care items or whatever else, we promise the most reduced cost in India.&nbsp;</span></div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">&nbsp;</span></div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">Compare, shop and earn cashback. This is what we want you to do.</span></div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">&nbsp;</span></div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">On Bigbasta you can think about items and costs crosswise over Amazon, Flipkart, Snapdeal, Shopclues, Infibeam and other top web shopping destinations. You can search by categories like mobiles and tablets, computers, laptops, apparel, books, sports or by top selling brands. This helps you spare time furthermore locate the ideal item at the best costs.&nbsp;</span></div>\n<div class="gmail_default">&nbsp;</div>\n<div class="gmail_default"><span style="font-family: verdana, sans-serif;">Lastly we give you Extra Cashback on almost every item you purchase through Bigbasta.com. When you click out from Bigbasta.com and purchase anything, retailers pay us commission. It was your money, spent for shopping so the cashback should be yours. Other guys keep your cashback to themselves. This makes us better.</span></div>\n<p><span style="font-family: verdana, sans-serif;">&nbsp;</span></p>\n</div>\n</div>', '', 1, 1, '2016-06-04 16:53:26'),
(18, 45, 'Contact us', '', 'contact_us', 3, 1, '2016-07-16 10:29:46'),
(10, 57, 'Cosmatics', '', '', 12, 1, '2016-06-17 18:01:34'),
(12, 2, 'About us', '<p>E-viral is owned by manish yadav.</p>', '', 1, 1, '2016-07-07 15:10:38'),
(13, 2, 'Contact us', '<p>contact&nbsp;</p>', 'contact_us', 2, 1, '2016-07-07 15:12:41'),
(14, 61, 'About Us', '<p>about us description of store</p>', '', 0, 1, '2016-07-12 12:53:30'),
(15, 61, 'Contact Us', '', 'contact_us', 0, 1, '2016-07-12 12:55:07');
...
INSERT INTO `slider` (`sl_id`, `name`, `data`, `status`) VALUES
(5, 'New Slider hai', 'a:1:{s:9:"slideData";a:3:{i:0;a:3:{s:5:"Image";s:59:"http://nexgen/guruvick.comadmin/upload/post/slider_img1.jpg";s:4:"Link";s:1:"#";s:4:"Text";s:6:"Text 1";}i:1;a:3:{s:5:"Image";s:61:"http://nexgen/guruvick.comadmin/upload/post/slider_img_11.jpg";s:4:"Link";s:1:"#";s:4:"Text";s:6:"Text 2";}i:2;a:3:{s:5:"Image";s:61:"http://nexgen/guruvick.comadmin/upload/post/slider_img_21.jpg";s:4:"Link";s:1:"#";s:4:"Text";s:6:"Text 3";}}}', 1);
...
INSERT INTO `users` (`uid`, `UTID`, `name`, `email`, `password`, `re_password`, `mobile`, `address`, `city`, `state`, `term_condition`, `verified`, `AddUser`, `ModeUser`, `ModeDateTime`, `status`) VALUES
(1, 1, 'Deepak Singh', 'abc@gmail.com', 'admin@123', '', '', '', '', '', 0, 1, 1, NULL, '2016-06-22 01:37:53', 1),
(2, 1, 'Kuldeep Singh', 'abc@gmail.com', 'admin@123', '', '', 'Delhi ,Dwaeka', '', '', 0, 1, 1, NULL, '2016-06-22 01:37:53', 1),
(3, 1, 'Mathu', 'math@gmail.co', 'admin', 'admin', '', 'Delhi', '', '', 0, 0, 0, NULL, '2016-09-06 14:31:42', 0),
(4, 2, 'Johan', 'kulldeep307373@gmail.com', '123456', '123456', '', 'Johan', '', '', 0, 0, 0, NULL, '2016-09-10 05:36:16', 1),
(5, 2, 'Mohan', 'mohan@gmail.com', 'admin@123', 'admin@123', '', 'New Delhi', '', '', 0, 1, 0, NULL, '2016-09-15 07:08:09', 1),
(6, 2, 'Sandeep', 'sandeep@gmail.com', 'admin@123', 'admin@123', '', 'Delhi height', '', '', 0, 1, 0, NULL, '2016-09-16 07:41:40', 0),
(7, 2, 'Mata Name hia', 'mata@gmail.com', 'admin@123', 'admin@123', '', 'Delhi se', '', '', 0, 1, 0, NULL, '2016-09-16 08:21:17', 1),
(8, 1, 'Akashay Dua', 'akshay@moremint.io', '123456', '123456', '', 'Delhi ,JanakPuri', '', '', 0, 0, 0, NULL, '2016-09-17 05:12:29', 1),
(9, 2, 'Atul Kumar', 'atul@gmail.com', '123456', '123456', '', 'Delhi ,Pitampura', '', '', 0, 0, 0, NULL, '2016-09-17 05:26:16', 0),
(10, 2, 'Rohit', 'rohit@gmail.com', 'admin@123', 'admin@123', '', 'delhi vikas puri', '', '', 0, 1, 0, NULL, '2016-10-06 08:05:14', 1),
(11, 2, 'nexgen', 'nexgen@gmail.com', 'nexgen123', 'nexgen123', '', 'Delhi,Dwarka mor', '', '', 0, 0, 0, NULL, '2016-10-06 09:15:49', 1),
(12, 2, 'Sandeep', 'sandeepmishra@gmail.com', 'sandeep', 'sandeep', '', 'dewaa', '', '', 0, 0, 0, NULL, '2016-10-07 07:00:02', 1),
(13, 3, 'PocketWeb', 'adops@moremint.io', 'AKSHAYAUD', 'AKSHAYAUD', '', 'D-1B/3A JANAK PURI', '', '', 0, 1, 0, NULL, '2016-10-19 11:36:31', 1),
(14, 3, 'Pocketweb', 'pocket@gmail.com', '123456', '123456', '', 'delhi', '', '', 0, 1, 0, NULL, '2016-10-19 11:37:59', 1),
(15, 1, '', '', '', '', '', '', '', '', 0, 1, 0, NULL, '2016-10-24 09:55:58', 1),
(16, 2, 'Spice Digital', 'prashant.sharma@spicedigital.in', 'spicein', 'spicein', '', 'Noida, India', '', '', 0, 1, 0, NULL, '2016-10-24 10:07:55', 1),
(17, 2, 'Test User', 'test@gmail.com', '123456', '123456', '', 'Delhi', '', '', 0, 1, 0, NULL, '2016-10-26 07:29:09', 1),
(18, 2, 'Ram', 'ram@gmail.com', 'ram123', 'ram123', '', 'Delhi ,Dwarka', '', '', 0, 1, 0, NULL, '2016-10-27 07:56:53', 1),
(19, 1, '', 'sandeep@gmail.com', '87587', '87587', '986589558', 'delhi', 'Delhi', 'Delhi', 1, 0, 0, NULL, '2016-11-08 07:48:46', 1),
(20, 1, '', 'kuldeep307373@gmail.com', 'hghfg', 'fghfg', '213123', 'fgh123', '123', '123', 1, 0, 0, NULL, '2016-11-08 07:49:06', 1);
...
CREATE TABLE IF NOT EXISTS `usertype` (
  `UTID` int(20) unsigned NOT NULL AUTO_INCREMENT,
  `usertype_name` varchar(20) NOT NULL,
  `AddDateTime` date NOT NULL,
  `ModeDateTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `usertype` (`UTID`, `usertype_name`, `AddDateTime`, `ModeDateTime`, `status`) VALUES
(1, 'admin', '2016-06-22', '2016-06-22 01:36:15', 1),
(2, 'affiliate', '2016-06-22', '2016-06-22 01:36:15', 1),
(3, 'Advertiser', '2016-06-22', '2016-06-22 01:36:15', 1);

<div class="row">
    ...
    <nav class="top-nav m-b-10">
        ...
        echo SITEURL . "advertiser/campaign/offerRequest/" . @$campaign_id;
        ?>">
...
<!--                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <?php
//                            echo form_dropdown("campaign_id", $camapign, isset($offerUrlData['campaign_id']) ? $offerUrlData['campaign_id'] : $campaign_id, "class='form-control select2' readonly=''") ?>  

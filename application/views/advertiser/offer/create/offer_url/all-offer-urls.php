                ...
                <h3 class=" panel-title">
                    All Landing Pages  <div class="pull-right">
                        <ul class="bulkActions">
                            <li><a href="<?php echo SITEURL . "advertiser/offer_urls/AddOfferLandingUrl/" . $campaign_id ?>" id="ShowGoalForm" class=" btn btn-info waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-plus"></span> LANDING PAGE</a></li>
                        </ul>
                    </div>
                </h3>
            </div>  
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat="ourl in offerUrls" id="tr{{ourl.url_id}}"  >
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo SITEURL . "advertiser/offer_urls/UpdateOfferUrl/" ?>{{ourl.url_id}}" type="button" class="btn btn-primary waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-edit"></span></a>
    ...
    var OfferUrlController = viral_pro.controller("OfferUrlController", function ($scope) {
        ...
        $scope.delete_ourl = function (url_id)
        {
            ...
            function (isConfirm) {
                ...
                {
                    $.ajax({
                        url: "<?php echo SITEURL . "advertiser/offer_urls/deleteOfferUrl" ?>",
                        type: 'POST',
                        data: "url_id=" + url_id,
                        dataType: 'json',

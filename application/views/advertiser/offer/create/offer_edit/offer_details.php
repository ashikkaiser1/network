            ...
            <div class="panel-heading"><h3 class="panel-title">
                    ...
                    <div class="pull-right">
                        <ul class="bulkActions">
                            <li><a href="<?php echo SITEURL ?>advertiser/campaign/offerRequest/<?php echo @$campaign['campaign_id'] ?>" class=" btn btn-info waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-eye"></span> View</a></li>
...
//                            echo form_dropdown("manager", $AccManager, isset($campaign['manager']) ? $campaign['manager'] : '', "class='form-control' ");
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <!--ng-blur="getHttpPost()"-->
                            <input type="text" class="form-control"  ng-model="preview_link" value="<?php echo isset($post['preview_link']) ? $post['preview_link'] : '' ?>" name="preview_link">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Default Url</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group " id="redirectOptio"  ng-show="redirection==1"   >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
//                            $status = $this->config->item("conv_status");
                          //  unset($camapign_status[1]);

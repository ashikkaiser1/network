        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <a href="http://tr.alfatraq.com/c_tr" target="_blank" class="btn btn-success  waves-effect waves-light"><span class="fa fa-link"></span> Test Conversion</a>
                    </div>
                </div>
...
<script>
    ...
    viral_pro.controller("TestingTab", function ($scope) {
        ...
        $scope.FormActionOfferUrl = "<?php echo SITEURL . "advertiser/offer_link_manager/get_offerUrl" ?>";
        $scope.FormActionOfferApproval = "<?php echo SITEURL . "advertiser/offer_link_manager/offerApprove" ?>";

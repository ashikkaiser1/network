<div class="row">
    ...
    <nav class="top-nav">
        <h2 class="page-heading blue-bg"><?php echo $title ?>

            <div class="pull-right">
                <a href="<?php echo SITEURL . "advertiser/campaign/showOffers" ?>"
                   class=" btn btn-warning waves-effect waves-light m-b-5 btn-sm"><span class="fa fa-list"></span> All Offers</a>
            </div> 
        </h2>
    </nav>
            ...
            <div class="panel panel-default"  ng-controller="AddOffer">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="catForm" role="form" ng-submit="CreateUpdateOffer()">                                    
                        ...
                        <?php $this->load->view("advertiser/offer/create/add-offer-widzard"); ?>
                        <div class="row">
...
//                                            echo form_dropdown("manager", $AccManager, isset($campaign['manager']) ? $campaign['manager'] : '', "class='form-control' ");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       class="form-control"  ng-model="preview_link" value="<?php echo isset($post['preview_link']) ? $post['preview_link'] : '' ?>" name="preview_link">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Traking Url</label>
                                            <div class="col-md-10">
                                                <input type="text" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" ng-model="click_span" name="click_span"class="form-control" placeholder="Number of days " value="<?php echo isset($campaign['click_span']) ? $campaign['click_span'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-10">
                                                <button type="button"
                                                        ng-if="url_slug !='' && title !='' && click_span !='' && click_span !=null && url_slug !=null && title !=null"
                                                        ng-click="ShowTab('PayoutTab')" class="btn btn-success  waves-effect waves-light">Next
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                 <?php
                                            foreach ($revenue as $id => $title) {
                                                ?>

                                                <div class="radio radio-success radio-single ">
                                                    <input ng-change="selectPayouttype()" type="radio" id="singleRadio<?php echo $id ?>" value="<?php echo $id ?>" checked="" ng-model="revenue_type"  name="revenue_type" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" id="payoutcost" 
                                                       ng-model="revenue_cost" 
                                                       class="form-control " 
                                                       value="<?php echo isset($campaign['revenue_cost']) ? $campaign['revenue_cost'] : '0' ?>" name="revenue_cost">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" ng-model="cap_limit" class="form-control" value="<?php echo isset($campaign['cap']) ? $campaign['cap'] : '0' ?>" name="cap">
                                                <!--<span class="help-block"><small>Set cap 0 if there is no limit</small></span>-->
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Total Budget <?php echo CURR ?></label>
                                            <div class="col-md-4">
                                                <input type="text" value="{{revenue_cost * cap_limit}}" class="form-control"  disabled=""> 
                                            </div>
                                        </div>
    ...
    // Getting notified of changes, and the new state:
                                        ...
                                        <div class="form-group ExtraFormGroup DailyCapContainer" style="display: none">
                                            <label class="col-md-2 control-label">Daily Cap</label>
                                            <div class="col-md-4">
                                                <input type="text" ng-model="daily_cap" class="form-control" 
                                                       onchanges="BudgetCalculate(this, 'DailyBudget')" 
                                                       value="<?php echo isset($campaign['cap']) ? $campaign['cap'] : '0' ?>" name="daily_cap">
                                                <span class="help-block"><small>Set cap 0 if there is no limit</small></span>
                                            </div>

                                            <label class="col-md-2 control-label">Daily Budget</label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" readonly="" id="DailyBudget" 
                                                       value="{{daily_cap*revenue_cost}}" name="daily_budget">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ExtraFormGroup MonthlyCapContainer" style="display: none">
                                            <label class="col-md-2 control-label">Monthly Cap</label>
                                            <div class="col-md-4">
                                                <input type="text" onchanges="BudgetCalculate(this, 'monthBudget')" 
                                                       class="form-control" 
                                                       value="" ng-model="monthly_cap" name="monthly_cap">
                                                <span class="help-block"><small>Set cap 0 if there is no limit</small></span>
                                            </div>

                                            <label class="col-md-2 control-label">Monthly Budget</label>
                                            <div class="col-md-4">
                                                <input type="text" readonly="" class="form-control" id="monthBudget" 
                                                       value="{{monthly_cap * revenue_cost }}" name="monthly_budget">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <button type="button" ng-if="cap_limit !='' || cap_limit !=0 "  ng-click="ShowTab('OfferSetTab')"  class="btn btn-success  waves-effect waves-light">Next
                                                    <span class="fa fa-arrow-right"></span>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <?php
                    $this->load->view("advertiser/offer/create/offer_test/testing");
                    ?>
...
//                                            },
                ...
                revenue_cost:{
                    validators: {
                         notEmpty: {
                            message: 'Payout cost must not empty. !!!'
                        },
                        numeric: {
...
//                            thousandsSeparator: '',
                ...
                cap:{
                    validators: {
                        notEmpty: {
                            message: 'Cap limit must not empty. !!!'
                        },
                        numeric: {
                            message: 'The cap limit is not a number',
                            // The default separators
//                            thousandsSeparator: '',
                            decimalSeparator: '.'
                        }
...
//                data: $("#catForm").serialize() + "&baseUrl_slug=" + url_slug,
        ...
        $scope.getHttpPost = function ()
        {
            ...
            $.ajax({
                url: "<?php echo SITEURL . "advertiser/post/getPostDataHttp" ?>",
                type: 'POST',
                data: 'url=' + url,
                dataType: 'json',
                success: function (data, textStatus, jqXHR) {

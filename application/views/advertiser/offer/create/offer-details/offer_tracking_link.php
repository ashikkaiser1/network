            ...
            <h3 class="panel-title">
                ...
                <div class="pull-right">
                    <ul class="bulkActions">
                        <li>
                            <a href="<?php
                            $post_id = isset($campaign['post_id']) ? $campaign['post_id'] : 0;
                            echo SITEURL . "admin/offer_postback/AddConvsrionUrlPixel/" . $post_id
...
//            $("#postcodep" + post_id).html("<img style='    width: 100px;    height: auto;    margin: 0 auto;    display: block;' src='<?php echo ASSETS . "images/30.gif" ?>' />");
            ...
            $.ajax({
                ...
                type: 'POST',
                data: 'post_id=' + post_id + '&domain_id=&campaign_id=' + campaign_id + "&uid=" + uid,
                dataType: 'json',

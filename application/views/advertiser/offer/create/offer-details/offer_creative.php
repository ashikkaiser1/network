...
if (isset($campaign['campaign_id'])) {
                            ...
                            <div class="form-group m-b-10 m-b-10">
                                <div class="panel-body">
                                    <div class="col-md-12 hidden" id="dropZoneUploader">
                                        <form id="FileUploader" action="<?php echo SITEURL . "advertiser/creative/upload_creative" ?>" class="dropzone" >
                                            <div class="fallback">
    ...
    <script>
        ...
        var creative_controller = viral_pro.controller("creative_controller", function ($scope) {
            ...
            $scope.FormAction = "<?php echo SITEURL . "advertiser/creative/getOfferCreative" ?>";
            $scope.currentPage = 1;
            ...
            $scope.delete_creative = function (creative_id)
            {
                ...
                function (isConfirm) {
                    ...
                    {
                        $.ajax({
                            url: "<?php echo SITEURL . "advertiser/creative/deleteCreative" ?>",
                            type: 'POST',

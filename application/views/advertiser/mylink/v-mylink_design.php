    ...
    <div class="col-sm-12">
        ...
        <div class="col-md-4" ng-repeat="post in allPost">
            <div class="post offer_cust m-b-10 m-t-10">
                ...
                <a href="<?php echo SITEURL . "advertiser/campaign/offerRequest/" ?>{{post.campaign_id}}"><img  src="{{post.image}}"/>
                </a>
                <div class="postData ">
    ...
    viral_pro.controller("camp_cont", function ($scope) {
        ...
        $scope.getPost = function (category_id) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: form + "&getPost=1&approvalReq=1&onlyMe=1&getPostNonCampaign=1&category_id=" + category_id + "&type=<?php echo OFFER ?>",
                dataType: 'json',
                success: function (data, textStatus, jqXHR) {

<div class="row" ng-controller="camp_cont">
    ...
    <?php $this->load->view("advertiser/common/menus"); ?>
    ...
    <div class="col-sm-12">
        ...
        <div class="col-md-4" ng-repeat="post in allPost">
            <div class="post post_cust">
                ...
                <img  src="{{post.image}}"/>
                <div class="postData "  ng-if="post.req_approval == 0 || (post.req_approval == 1 && (already_approved(post.campaign_id)))">
                ...
                <div class="postData " ng-if="post.req_approval != 0 && !(already_approved(post.campaign_id))" >
    ...
    viral_pro.controller("camp_cont", function ($scope) {
        ...
        $scope.getPost = function (category_id) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: "getPost=1&approvalReq=1&getPostNonCampaign=1&category_id=" + category_id + "&type=<?php echo OFFER ?>",
                dataType: 'json',
                success: function (data, textStatus, jqXHR) {

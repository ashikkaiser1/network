                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" > 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" readonly="" class="form-control" name="email" value="<?php echo isset($UserEmail) ? $UserEmail : '' ?>" placeholder="Johan@xyz.com">
                                    </div>
                                    <!--                                    <div class="col-md-10">
                                                                            <h6></h6>
...
<!--                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="button"   href="#collapseThree"  class="btn btn-purple waves-effect waves-light">{{saveBtn}}</button>
                        ...
                        <div id="collapseThree" class="panel-collapse collapse in"  > 
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea  id="example-email"  name="contact_notes" class="form-control" placeholder=""></textarea>
                                    </div>
                                </div>
...
<!--                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="button"   href="#collapseTwo" class="btn btn-warning waves-effect waves-light">{{PreBtn}}</button>
                                        <button type="button"   href="#collapseFour" class="btn btn-purple waves-effect waves-light">{{saveBtn}}</button>
...
<!--                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="button"   href="#collapseThree" class="btn btn-warning waves-effect waves-light">{{PreBtn}}</button>
                                        <button type="button"   href="#collapseFive" class="btn btn-purple waves-effect waves-light">{{saveBtn}}</button>
                        ...
                        <div id="collapseFive" class="panel-collapse collapse in"  > 
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="paypal_email" value=""  class="form-control" >
                                    </div>
                                </div> 
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="payoneer" value=""  class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="submit" class="pull-right btn btn-success waves-effect waves-light">{{saveBtn}}</button>

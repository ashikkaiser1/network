...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding: 0'><span style="text-transform:uppercase">Password?</span></h2>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        <a class="mcnButton " href="<?php echo SITEURL."account/account/reset_password?in_code=".$in_code ?>" style="mso-line-height-rule: exactly;

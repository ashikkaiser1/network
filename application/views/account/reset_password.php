        ...
        <div class="col-lg-12" style="    margin: 6% auto;"> 
            <form class="form-horizontal" role="form" id="password_reset_from" ng-submit="reset_my_password()"> 
                <div class="panel-group panel-group-joined" id="accordion-test"> 
                    <div class="panel panel-color panel-pink  panel-pages"> 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a style="    margin: 0 0 0 7px;" href="<?php echo SITEURL ?>" class="btn btn-pink m-l-2 waves-effect waves-light pull-right">Login</a>
                                        <a href="<?php echo SITEURL."account/account/CreateAccountRequest" ?>" class="btn btn-success  m-l-2 waves-effect waves-light pull-right">Create New Account?</a>

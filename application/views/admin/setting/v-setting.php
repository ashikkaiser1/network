<div class="row" ng-controller="sett_con">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="usersForm_basic" ng-submit="updateUser('basic')"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="email" readonly="" id="example-email" value="<?php echo isset($user['email']) ? $user['email'] : '' ?>"  name="email" class="form-control" placeholder="johan@email.com">
                                            </div>
                                        </div>
...
<script>
   // var setting_app = angular.module("setting_app", ['ui.bootstrap']);
    viral_pro.controller("sett_con", function ($scope) {
        ...
        $scope.FormAction = "<?php echo SITEURL . "admin/setting/setting_edit" ?>";

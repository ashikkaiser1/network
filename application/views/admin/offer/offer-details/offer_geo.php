            ...
            <h3 class="panel-title">
                ...
                <div class="pull-right">
                    <ul class="bulkActions">
                        <li><a href="<?php echo SITEURL . "admin/offer/setTargetting/" . $campaign_id ?>"  class=" btn btn-info waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-plus"></span> TARGETING</a></li>
                    </ul>
                </div>
            </h3></div>

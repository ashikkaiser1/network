                ...
                <h3 class="panel-title">
                    ...
                    <div class="pull-right">
                        <ul class="bulkActions">
                            <li><a href="<?php echo SITEURL . "admin/offer/UpdateOfferPayout/" . $campaign['campaign_id'] ?>"  class=" btn btn-success waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-edit"></span> Edit</a></li>

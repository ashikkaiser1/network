                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 m-t-10 m-b-10 searchCustom">
                        ...
                        <form id="searchForm" class="form-inline" role="form" ng-submit="searchByForm()" >
                            ...
                            <div class="form-group m-l-10">
                                ...
                                <input type="text" name="search" class="form-control input-sm" id=""  placeholder="Company, Offer ID">
                            </div>
                            ...
                            <div class="table-responsive table  table-hover">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="pixel in all_pixel" id="tr{{pixel.uop_id}}">
                                            <td>
                                                <input class="campaign_ids" ng-checked="selectAllOffers" type="checkbox" name="pixeldel[]" value="{{pixel.uid}}_{{pixel.campaign_id}}"/>
                                            </td>
                                            ...
                                            <td> 
                                                <a type="button" href="<?php echo SITEURL . "admin/offer_postback/AddUserOfferPostbacks/" ?>{{pixel.campaign_id}}/{{pixel.uid}}"  class="btn btn-primary waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-edit"></span></a>
...
<!--                                                <button type="button" ng-click="delete_postabck(pixel.link_id)" class="btn btn-danger waves-effect waves-light m-b-5 btn-xs"><span class="fa fa-trash"></span></button>-->
                                ...
                                <div ng-if="all_pixel == ''" style="text-align: center; font-size: x-large;" class="ng-scope">
                                    No Data Found!!
                                </div>
                            </div>
...
<script>
    ...
    var pixel_controller = viral_pro.controller("pixel_controller", function ($scope) {
        ...
        $scope.all_pixel = {};
        $scope.searchBtn = "";
        $scope.FormAction = "<?php echo SITEURL . "admin/usr_offer_link_postback/getAffiliatesPostback" ?>";
            ...
            swal({
                ...
                closeOnCancel: true
                    ...
                    function (isConfirm) {
                        ...
                        {
                            $.ajax({
                                url: "<?php echo SITEURL . "admin/usr_offer_link_postback/delete_postback" ?>",
                                type: 'POST',
                                data: form,
                                dataType: 'json',
                                success: function (data, textStatus, jqXHR) {

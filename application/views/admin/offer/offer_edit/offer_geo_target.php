    ...
    <div class="col-sm-12">
        <div class="panel panel-default"  ng-controller="AddOfferGeoTarget">
            <div class="panel-heading"><h3 class="panel-title">
                    <a href="<?php echo SITEURL . "admin/campaign/offerRequest/" . $campaign['campaign_id'] ?>" class=" btn btn-purple waves-effect waves-light m-b-5 btn-sm"> <?php echo isset($campaign['campaign_name']) ? $campaign['campaign_name'] : '' ?></a>
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="catForm" role="form" ng-submit="CreateUpdateOfferGeoTarget()">                                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" ng-model="title" readonly="" value="<?php echo isset($campaign['campaign_name']) ? $campaign['campaign_name'] : '' ?>" name="campaign_name">
                        </div>
                    </div>
...
//    print_r($campaign);
    ?>
            ...
            console.log($scope.Alloffer_OS + " " + $scope.Alloffer_devices);

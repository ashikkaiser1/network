            ...
            <div class="panel-body">
                <form class="form-horizontal" id="GoalForm" role="form" ng-submit="CreateGoal()">   
                    ...
                    <!--                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                    <?php
                    // echo form_dropdown("goal_id", $global_goals, isset($goal['goal_id']) ? $goal['goal_id'] : '', "class='form-control'");
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
                            echo form_dropdown("revenue_type", $revenue, isset($goal['revenue_type']) ? $goal['revenue_type'] : '', "class='form-control'");
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
                            echo form_dropdown("payout_type", $payout, isset($goal['payout_type']) ? $goal['payout_type'] : '', "class='form-control'");
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control " value="<?php echo isset($goal['payout_cost']) ? $goal['payout_cost'] : '' ?>" name="payout_cost">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <?php
                            echo form_dropdown("off_goal_status", array("1" => "Active", "0" => "De-Active"), isset($goal['off_goal_status']) ? $goal['off_goal_status'] : '', "class='form-control'");
                            ?>
...
<script>
    ...
    viral_pro.controller("Goals", function ($scope) {
        ...
        {
            $.ajax({
                url: "<?php echo SITEURL . "admin/goals/show_goals/" ?>" + campaign_id,
                type: 'POST',
                dataType: 'json',
//                data: $("#GoalForm").serialize(),
                success: function (data, textStatus, jqXHR) {
...
//                    {
        ...
        $scope.delete_offer_goal = function (offer_goal_id)
        {
            ...
            function (isConfirm) {
                ...
                {
                    $.ajax({
                        url: "<?php echo SITEURL . "admin/goals/deleteGoal" ?>",
                        type: 'POST',

...
//                                                  
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 ">
        ...
        <div class="pull-left">
            <a href="<?php echo SITEURL . "admin/conversion_report/convertion_bulk" ?>" class=" btn btn-pink waves-effect waves-light m-b-5 btn-sm"><span class="fa fa-plus"></span> Import Conversion</a>
        </div>
        <div class="pull-right">
            <ul class="bulkActions">
                <li>
                    <a title="Action Chnage Status" href="" class=" btn btn-success waves-effect waves-light m-b-5 btn-sm"><span class="fa fa-anchor"></span> Actions </a>
                    <ul class="subOptions">
                        <li><a href="#" ng-click="bulkchange_conv_status(1)">Approve</a></li>
                        <li><a href="#" ng-click="bulkchange_conv_status(0)">Reject</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content panel"> 
            <div class="tab-pane active" id="home-2" style="display: block;"> 
                <form id="ConvertionsAppReject">
                    <table class="table table-responsive ">
                        <thead class="tophead">
                            <tr>
    <!--                            <th>#</th>-->
                                <th><input type="checkbox" ng-model="selectConvertion"/></th>
    ...
    <!--                            <td>{{ $index + 1}}</td>-->
                                ...
                                <td>
                                    <input class="campaign_ids" ng-checked="selectConvertion" type="checkbox" name="transaction_id[]" value="{{repo['transaction_id']}}"/>
                                </td>
                                ...
                                <td ng-repeat="col in coloumnName">
                                    ...
                                    <a ng-if="col == 'Aff_Name' || col == 'Aff_id'" href="<?php echo SITEURL . "admin/users/ViewUser/" ?>{{repo['Aff_id']}}">
                                        {{repo[col]}}
                                    </a>


                                    <span ng-if="col == 'Conv_Status'">
                                        <span class="text-success" ng-if="repo[col] == 1">
                                            Approved
                                        </span>
                                        <span class="text-danger" ng-if="repo[col] == 0">
                                            Rejected
                                        </span>
                                    </span>

                                    <span ng-if="col != 'Offer_ID' && col != 'Conv_Status' && col != 'Offer_Name' && col != 'Aff_Name' && col != 'Aff_id'"> {{repo[col]}}</span>
                                ...
                                <td>
                                    ...
                                    <span class="text-success" ng-if="repo['Conv_Status'] == 1">
                                        <button class="btn btn-danger btn-xs waves-effect waves-light" type="button" ng-click="change_conv_status(repo['transaction_id'], 0)"><span class="fa fa-remove"></span>Reject</button>
                                    </span>
                                    <span class="text-danger" ng-if="repo['Conv_Status'] == 0">
                                        <button class="btn btn-xs btn-success waves-effect waves-light" type="button" ng-click="change_conv_status(repo['transaction_id'], 1)"><span class="fa fa-check"></span>Approve</button>
                                    </span>
...
<script>
    ...
    viral_pro.controller("rep_con", function ($scope) {
        ...
        $scope.FormAction = "<?php echo SITEURL . "admin/conversion_report/getConAdvanceReport" ?>";
        ...
        $scope.change_conv_status = function (transaction_id, c_valid)
        {
            ...
            swal({
                ...
                closeOnCancel: true
                    ...
                    function (isConfirm) {
                        ...
                        {
                            $.ajax({
                                url: "<?php echo SITEURL . "admin/conversion_report/ChangeStatus" ?>",
                                type: 'POST',
                                data: 'transaction_id=' + transaction_id + "&c_valid=" + c_valid,
                                dataType: 'json',
                                success: function (data, textStatus, jqXHR) {
                                    if (data['success'])
                                    {
                                        ...
                                        $scope.getAdvReportByTransaction(transaction_id);
                                    } else
                                    {
...
//                    $scope.calculate(data);
        ...
        $scope.bulkchange_conv_status = function (c_valid)
        {
                    ...
                    function (isConfirm) {
                        if (isConfirm)
                        {
                            $.ajax({
                                url: "<?php echo SITEURL . "admin/conversion_report/ChangeStatus" ?>",
                                type: 'POST',
                                data: $("#ConvertionsAppReject").serialize() + "&c_valid=" + c_valid,
                                dataType: 'json',
                                success: function (data, textStatus, jqXHR) {
                                    if (data['success'])
                                    {
...
//        };
        ...
        $scope.getAdvReportByTransaction = function (transaction_id)
        {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    {
                        $.each($scope.advance_report, function (index, item) {

                            if (item['transaction_id'] === transaction_id)
                            {
                                $scope.advance_report[index] = data['data'][0];
                            }
                        });
                        $scope.$apply();

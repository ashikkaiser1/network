...
<div class="row" ng-controller="camp_cont">
    <nav class="top-nav">
        <h2 class="page-heading blue-bg">Offer Explorer</h2>
    </nav>
...
<!--                                <img  src="{{check_image(post.image)}}"/>-->
                                ...
                                <div class="postData ">
                                    <h2 class="title title_cust col-md-10">
                                        ...
                                        <a  title="{{post.title}}" target="_blank" href="<?php echo SITEURL . "affiliate/campaign/offerRequest/" ?>{{post.campaign_id}}">
<!--                                            <div class="postImage">
                                                <img ng-if="post.image != ''" src="{{post.image}}"/>
                                                <img ng-if="post.image == ''" src="http://www.freeiconspng.com/uploads/no-image-icon-6.png"/>

                ...
                <form class="form-horizontal" id="OfferRequestForm" role="form" ng-submit="CreateRequest()">                                    
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <input  type="text" class="form-control" ng-model="offerpro" value="" name="offerpro">
                        </div>
                    </div>  

                    <div class="form-group">
                        <label class="col-md-12 control-label"  style="text-align:  left"> 
                            <input name="terms_cond" value="1"   type="checkbox" class="check"> Do you agree Terms and Condition?
                        </label>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-10">
                            ...
                            <button type="submit" class="btn btn-success waves-effect waves-light">{{saveBtn}}</button>
...
<script>
    ...
    viral_pro.controller("affiliate_apply_for_offer", function ($scope) {
        ...
        $scope.action = "<?php echo SITEURL . "affiliate/campaign/affiliate_apply_for_offer" ?>";

<div class="col-md-12">
       <div class="card" id="OfferUrlController" ng-controller="OfferUrlController" >
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 m-t-10 m-b-10 searchCustom " Style="display: none;">
                            <!--                        search-->
                            <form id="OfferURLSearchForm"  class="form-inline " role="form" ng-submit="SearchByOfferID()" >
...
<script>
    ...
    var OfferUrlController = viral_pro.controller("OfferUrlController", function ($scope) {
        ...
        $scope.offerUrls = {};
        $scope.searchBtn = "";
        $scope.FormAction = "<?php echo SITEURL . "affiliate/offer_urls/showOfferUrls" ?>";


        $scope.currentPage = 1;
        $scope.numPerPage = 10;

        $scope.SearchByOfferID = function () {
            $scope.currentPage = 1;
            $scope.search_offer_landing_page();
        };
        ...
        $scope.search_offer_landing_page = function () {
            $scope.searchBtn = "";
            var form = $("#OfferURLSearchForm").serialize();
            console.log(form);
            $.ajax({

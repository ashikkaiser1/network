                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 m-t-10 m-b-10 ">
                        ...
                        <form id="SetPixelForm" class="form-horizontal" role="form" ng-submit="AddConverPixeUrl()" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" rows="3" name="post_back">{{post_back}}</textarea>
                                </div>
                            </div>
...
<script>
    ...
    var genUrlController = viral_pro.controller("genUrlController", function ($scope) {
        ...
        $scope.FormAction = "<?php echo SITEURL . "affiliate/campaign/setConversionPixelUrl" ?>";
        ...
        $scope.getAffPixel = function(uid,post_id){
            
            
            $.ajax({
               url: "<?php echo SITEURL . "affiliate/offer_postback/show_offer_postbacks" ?>",
               type: 'POST',
               ...
               success: function (data, textStatus, jqXHR) {
                        ...
                        if(typeof  data[0] != "undefined"){
                            $scope.post_back = data[0]['post_back'];
                        }
        ...
        $scope.getAffPixel('<?php echo @UID ?>', '<?php echo isset($campaign['post_id']) ? $campaign['post_id'] : 0 ?>');

<div class="col-lg-12" ng-controller="trackingLink">
    ...
    <div class="col-lg-12" id="postcode<?php echo isset($campaign['post_id']) ? $campaign['post_id'] : 0 ?>">
        ...
        <div  class="col-md-12" title="Copy Url">
            ...
            <button ng-click="getCode('<?php echo isset($campaign['post_id']) ? $campaign['post_id'] : 0 ?>', <?php echo isset($campaign['campaign_id']) ? $campaign['campaign_id'] : 0 ?>)" class="btn btn-success waves-effect waves-light"   ><span class="fa "></span>GET</button>
        </div><br>
<div class="alert alert-success">
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                                            <h3 class="text-success"><i class="fa fa-check-circle"></i> Parameter</h3> 
                                            &aff_sub=subid&aff_sub2=subid2&aff_sub3=subid3<br>
                                        </div>
...
<script>
    ...
    viral_pro.controller("trackingLink", function ($scope) {
        ...
        $scope.getCode = function (post_id, campaign_id)
        {
            ...
            $.ajax({
                url: "<?php echo SITEURL . "affiliate/usr_offer_link_postback/generate_tracking_link" ?>",
                type: 'POST',
                data: 'domain_id=&campaign_id=' + campaign_id,
                dataType: 'json',
        ...
        $scope.getLandingPages = function () {
            ...
            $.ajax({
                url: "<?php echo SITEURL . "affiliate/offer_urls/showOfferUrls" ?>",
                type: 'POST',
                data: form,
                dataType: 'json',
                success: function (data, textStatus, jqXHR) {

<div class="page-wrapper" id="App2" ng-controller="noti_controller">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                   ...
                   <div class="card">
                    ...
                    <ul class="col-md-12 list-unstyled" >
                        ...
                        <li class="list-group">
                            <!-- list item-->
                                ...
                                <div class="row" ng-repeat="noti in notification">
                                    
                                <div class="form-group col-md-2">
                                    <div class="bottom-calander">
                                        <div class="font18"> {{noti.n_date}} </div>
                                        <div class="font10 "> {{noti.n_monnth}} {{noti.n_year}} </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-10">
                                 
                                    <div class="media-body clearfix">
                                        <h3 class="text-success"><i class="fa fa-exclamation-circle"></i> {{noti.title}}</h3>
                                        <div ng-bind-html="reder_html(noti.description)" class="alert alert-warning"> </div>
                    ...
                    <div ng-if="notification == ''" style="text-align: center; font-size: x-large;" class="ng-scope">
                                    No Data Exist!!
                                </div>

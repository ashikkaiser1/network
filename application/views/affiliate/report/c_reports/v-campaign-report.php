<div class="page-wrapper" ng-controller="rep_con">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                     <h3 class="text-themecolor">Campaign Report</h3>
                </div>
    ...
    display: none!important;
        ...
        <div class="col-sm-12">
            <div class="card" id="accordion-test"> 
                <div class="" >
                    <div class="card-body">
                        <a data-toggle="collapse" id="hideme" data-parent="#accordion-test" href="#collapseOne" aria-expanded="true">
                                ...
                                <div class="col-md-9 col-sm-6 col-xs-12  ">
                                    ...
                                    <div class="form-group col-md-3">
                                       ...
                                       <div class="form-group col-md-7">
                                        ...
                                        <div class="row">
                                        <div class="form-group col-md-3">
                                        <label class="col-md-12 control-label">Top 5 Campaigns by</label>
                                        </div>
                                       <div class="form-group col-md-9">
                                        
                                                <?php echo form_dropdown("orderby", array("clicks" => "Clicks", "conversion" => "Conversion", "payout" => "Payout"), '', "class='form-control  '") ?>  

...
<div class="col-lg-6">
    <div class="card" ng-controller="featuredOffers" >
        ...
        <div class="card-body"> 
        <h3 class="card-title">Featured Offers</h3> 
            <table class="table">

                <tbody>
                    <tr ng-repeat="offers in featuredOffers"> 
                        <td> <span>{{offers.campaign_name}}({{offers.campaign_id}})</span> </td>
                        <td>  <a href="<?php echo SITEURL."affiliate/campaign/offerRequest/" ?>{{offers.campaign_id}}" class=" btn btn-xs btn-primary pull-right"><span class="fa fa-eye  " title="Go to offer"></span></a></td>
                    </tr>
                </tbody>

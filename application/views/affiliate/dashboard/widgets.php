                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <!-- Row -->
                                <div class="row">
                                    <div class="col-8"><h2>{{AllConversionRate| number : 2}} % <i class="ti-angle-up font-14 text-success"></i></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <!-- Row -->
                                <div class="row">
                                    <div class="col-8"><h2>{{AllCost| number : 2}}
                            ...
                            /<span style="font-size: 18px">
                                ...
                                ?> 
                            </span> <i class="ti-angle-down font-14 text-danger"></i></h2>
                                        <h6>Payout (<?php echo CURR;?>)</h6></div>
                                    <div class="col-4 align-self-center text-right p-l-0">

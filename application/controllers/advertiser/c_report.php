...
//        $data['Camapign'] = $camp;
        ...
        switch ($report_type) {
            case 'offers_report':
                $data['PageContent'] = $this->load->view("advertiser/report/c_reports/v-campaign-report", $data, TRUE);
                break;
            case 'daily_report':
                $data['PageContent'] = $this->load->view("advertiser/report/c_reports/v-performance-report", $data, TRUE);
                break;
            case 'conversion_report':
                $data['PageContent'] = $this->load->view("advertiser/report/c_reports/v-conversion-report", $data, TRUE);
                break;
             case 'detail_report':

...
class setting extends CI_Controller {
    ...
    public function index() {
      ...
      //  echo "<pre>";
       ...
       if($request)
       {
        ...
        $data['globalPostBack'] = $this->load_controller("advertiser/modules/globalpostback");

        $data['PageContent'] = $this->load->view("advertiser/setting/v-setting", $data, TRUE);
    ...
    public function my_profile() {
        ...
        $filters['uid'] = UID;
        $data['user'] = $this->m_users->getUsers($filters);
        $data['PageContent'] = $this->load->view("advertiser/setting/v-my-profile", $data, TRUE);
        $this->load->view("advertiser/template", $data);
    }
...
//        exit;
        ...
        $data['PageContent'] = $this->load->view("advertiser/setting/v-payment", $data, TRUE);
        $this->load->view("advertiser/template", $data);
    }
...
//        $data['user'] = $this->m_users->getUsers($filters);
        ...
        $data['PageContent'] = $this->load->view("advertiser/setting/v-gbp", $data, TRUE);
        $this->load->view("advertiser/template", $data);
    }

...
class api_token extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model("affiliate/m_api");
...
//        echo '<pre>';
//        print_r($data);
        $data['PageContent'] = $this->load->view("affiliate/api_token/v-api-token", $data, TRUE);
    ...
    public function generateToken() {
        ...
        if ($request) {
            ...
            if ($this->m_api->setToken($usr_token)) {
                ...
                $notification['description'] = $this->load->view("affiliate/common/notif_layout/v-api-approval-request", $data, true);

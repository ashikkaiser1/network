            ...
            if (!empty($offers['offers'])) {
                foreach ($offers['offers'] as $key => $row) {
                    ...
                    if (is_array($row['category'])) {
                        $meta .= "Category :" . stripslashes(trim(trim(strip_tags(implode(",", $row['category'])))));
                    } else {
                    ...
                    $campaign['url_slug'] = isset($row['offerlink']) ? $row['offerlink'] . $this->tracking_urlExtension : '';
                    ...
                    if (isset($row['offerphoto']))
                        $campaign['image'] = $row['offerphoto'];

...
$db['default']['username'] = 'clickoffer';
$db['default']['password'] = 'clickoffer';
$db['default']['database'] = 'clickoffer';
...
$db['db_reader']['username'] = 'clickoffer';
$db['db_reader']['password'] = 'clickoffer';
$db['db_reader']['database'] = 'clickoffer';
